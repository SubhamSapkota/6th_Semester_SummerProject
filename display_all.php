                ...
                <div class="collapse navbar-collapse fw-bold" id="navbarSupportedContent">
                    <ul class="navbar-nav    me-auto mb-2 mb-lg-0">
                        ...
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item ">
                            <a class="nav-link " href="cart.php"><i class="text-white fa-solid fa-cart-shopping "><sup class=" bg-danger text-white"><?php cart_item(); ?></sup></i></a>
                            </li>

                            <li class="nav-item text-white">
                                <a class="nav-link" href="#"><i class="text-white fa-solid fa-credit-card"></i></a>
                            </li>
                        </ul>
                        <li class="nav-item ">
                        <a class="nav-link text-white" href="#">Total Amount: <?php total_cart_price(); ?>/-</a>
                        </li>
                    </ul>
