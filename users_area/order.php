...
// $querySelect = "SELECT 'username' FROM `user_table`";
...
$insert_pending_orders="Insert into `orders_pending` (user_id,username,invoice_number,product_id,quantity,order_status) 
values($user_id,$user_username,$invoice_number,$product_id,$quantity,'$status')";
