...
if(isset($_POST['confirm_payment'])){
    ...
    if($result){
        echo"<h3 class='text-center text-light'>'Successfully completed the payment.Thank you!!!'</h3>";
...
<body class="bg-warning">
    <div class="container my-5">
     ...
     <form action="" method="post">
        ...
        <div class="form-outline my-4 text-center w-50 m-auto">
            <input type="submit" class="bg-dark py-2 px-3 border-0 text-light" value="Confirm" name="confirm_payment">
        </div>
