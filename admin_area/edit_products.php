<!-- php code forediting products by admin -->
<?php
   ...
   ?>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image1 ?>" alt="image" class="product_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <<img src="./product_images/<?php echo $product_image2 ?>" alt="image" class="product_img">
            </div>
        </div>
        <div class="form-outline w-50  m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <<img src="./product_images/<?php echo $product_image3 ?>" alt="image" class="product_img">
            </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
if(isset($_POST['edit_products'])){
    ...
    // checking for fieldempty or not
